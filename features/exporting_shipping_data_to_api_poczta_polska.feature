...
Feature: Managing shipping gateway
    ...
    Background:
        ...
        And there is a registered "poczta_polska" shipping gateway for this shipping method named "PocztaPolska"
        And it has "wsdl" field set to "https://en-testwebapi.poczta-polska.pl/websrv/en.wsdl"
